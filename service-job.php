	...
	<div class="container">
		<div class="row">
			<div class="grid-5 grid-12_s">
				...
				<div class="about-dir__sert-list">
					<a href="/img/about/sert/1.jpg" class="doc fancy" title="Увеличить" data-fancybox="docs-cons">
						<figure class="doc__frame">
							<img src="/img/about/sert/1.jpg" alt="1">
						</figure>
					</a>
				...
				<div class="about-dir__cons-btn">
					<a href="#" class="btn btn--outline fancy" data-src="#modal-smeta">Консультация специалиста</a>
				</div>
			</div>
			<div class="grid-7 grid-12_s">
				<div class="man-frame">
					<img src="/img/about/stripes.jpg" alt="stripes" class="man-frame__stripes">
					<img src="/img/about/man-2.png" alt="stripes" class="man-frame__man">
				</div>
			</div>
		</div>
	</div>
